...
import FeaturedProductForm from "./pages/Beranda/FeaturedProductForm";
import ConsultationForm from "./pages/Beranda/ConsultationForm";
import ContactTeamForm from "./pages/Beranda/ContactTeamForm";
import PartnerForm from "./pages/Beranda/PartnerForm";
import Article from "./pages/Article";
import "./styles/global.css";
import LokasiSettings from './pages/LokasiSettings';
import ProjectKategori from "./pages/Project/ProjectKategori";
