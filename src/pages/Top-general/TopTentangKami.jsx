...
const TopTentangKami = () => {
  ...
  const handleSubmit = (e) => {
    ...
    console.log("Data Top Tentang Kami:", formData);

    alert("Top Tentang Kami berhasil disimpan!");
  };
        ...
        <form onSubmit={handleSubmit} className="px-16 py-5">
          ...
          <div className="mb-4">
            ...
            <input
              ...
              onChange={handleChange}
              placeholder="Masukan judul halaman dalam bahasa inggris"
