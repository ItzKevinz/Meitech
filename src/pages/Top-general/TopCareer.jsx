...
const Career = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log("Data Career / Karir:", formData);
    alert("Data Karir berhasil disimpan!");
  };
    ...
    <div className="min-h-screen bg-[#F8F4E9] px-4 py-5 font-[Nunito_Sans]">
      ...
      <section className="rounded-md bg-white shadow-sm">
        ...
        <form onSubmit={handleSubmit} className="px-16 py-5">
          ...
          <div className="mb-4">
            ...
            <div className="relative">
              <input
                ...
                placeholder="Masukan label utama"
                ...
                style={{
                  color: formData.labelColor || "#333333",
                  opacity: (formData.labelOpacity ?? 100) / 100,
                }}
              />
              ...
              <div className="absolute right-2 top-1/2 -translate-y-1/2">
                <ColorPicker
                  ...
                  opacity={formData.labelOpacity}
                  onChange={(color) => {
                    setFormData((prev) => ({
                      ...prev,
                      labelColor: color.hex,
                      labelOpacity: color.opacity,
                    }));
                  }}
                />
              </div>
          ...
          {/* LABEL DALAM BAHASA INGGRIS (Ngikut warna & opacity dari Label Utama) */}
          <div className="mb-4">
          ...
          <div className="mb-4">
            ...
            <div className="relative">
              <input
                ...
                className="w-full rounded-md border border-[#D5D5D5] bg-[#F7F3E9] px-3 py-2.5 pr-32 text-[10px] shadow-sm outline-none placeholder:text-[#999] focus:border-[#FDCB01]"
                style={{
                  color: formData.titleColor || "#333333",
                  opacity: (formData.titleOpacity ?? 100) / 100,
                }}
              />
          ...
          <div className="mb-4">
            ...
            <div className="relative">
              <textarea
                ...
                style={{
                  color: formData.descriptionColor || "#333333",
                  opacity: (formData.descriptionOpacity ?? 100) / 100,
                }}
              />
