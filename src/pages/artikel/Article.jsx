      ...
      <div className="w-full flex flex-col gap-6">
        ...
        {viewMode === 'list' && (
          <>
            <div className="bg-white rounded-xl p-5 md:px-8 shadow-sm text-left w-full">
              <h1 className="m-0 text-2xl font-bold text-black tracking-tight">Artikel</h1>
            </div>

            <div className="bg-white rounded-xl p-8 shadow-sm text-left flex flex-col gap-3 w-full">
              <h2 className="text-xl font-semibold text-[#1A1A1A] m-0">Semua artikel</h2>
              <hr className="-mx-8 border-t border-[#EAEAEA] mb-4" />
              ...
              <form onSubmit={handleMainSubmit} className="flex flex-col gap-7 w-full">
                ...
                <div className="flex justify-start mt-2">
                  <button
                    ...
                    className="bg-[#FFD600] hover:bg-[#e6c200] text-black font-bold text-xs px-5 py-2.5 rounded-lg shadow-sm transition-all cursor-pointer border-none"
                  >
                    Tambah artikel baru
                  </button>
                </div>
                ...
                <div className="border border-[#D1D5DB] rounded-2xl overflow-hidden bg-white w-full shadow-xs mt-2">
                  ...
                  {/* HEADER FLEX */}
                  <div className="bg-[#F7F3E9] border-b border-[#EAEAEA] flex items-center px-4 py-3.5 font-bold text-black text-xs">
                  ...
                  <div className="divide-y divide-[#E0E0E0]">
                    {articles.map((article, index) => (
                      ...
                      >
                        {/* No */}
                        <div className="w-[6%] text-center text-gray-700 font-normal text-xs">
                          {index + 1}.
                        </div>

                        {/* Judul */}
                        <div className="w-[34%] text-center font-normal px-2 leading-relaxed text-xs">
                        ...
                        {/* Publisher */}
                        <div className="w-[14%] text-center font-normal text-xs">
                          {article.publisher}
                        </div>

                        {/* Waktu */}
                        <div className="w-[16%] text-center font-normal text-xs">
                        ...
                        <div className="w-[16%] flex items-center justify-center gap-2">
                          <button
                            ...
                            className="bg-[#FFD600] hover:bg-[#e6c200] text-black font-semibold text-[10px] px-4 py-2 rounded-xl transition-all cursor-pointer border-none"
                          >
                            Edit
                          </button>
                          <button
                            ...
                            className="bg-[#FF0000] hover:bg-[#cc0000] text-white font-semibold text-[10px] px-4 py-2 rounded-xl transition-all cursor-pointer border-none"
                          >
                            Hapus
                          </button>
                        </div>
        ...
        {viewMode === 'form' && (
          <div className="w-full flex flex-col gap-6">
            ...
            {/* Card Utama Form */}
            <div className="bg-white rounded-xl py-8 px-6 md:px-10 shadow-sm text-left w-full">
              ...
              {/* Form  */}
              <form onSubmit={handleSaveArticle} className="flex flex-col gap-7 w-full px-4 md:px-12">
                ...
                <div className="flex flex-col items-start gap-2 w-full">
                  ...
                  <div className="relative w-full">
                    <input
                      ...
                      className="w-full bg-[#F7F3E9] border border-[#EAE4D7] rounded-lg p-3.5 pr-10 text-xs text-[#333333] outline-none shadow-sm focus:ring-2 focus:ring-[#7EC07E] cursor-pointer"
                    />
                    <ChevronDown size={18} className="absolute right-3.5 top-1/2 -translate-y-1/2 text-gray-700 pointer-events-none" />
                  </div>
                </div>
                ...
                <div className="flex flex-col items-start gap-2 w-full">
                  ...
                  <textarea
                    ...
                    rows={5}
                    className="w-full bg-[#F7F3E9] border border-[#EAE4D7] rounded-lg p-3.5 text-xs text-[#333333] outline-none resize-none shadow-sm focus:ring-2 focus:ring-[#7EC07E]"
                  />
                </div>
                ...
                <div className="flex flex-col items-start gap-2 w-full">
                  ...
                  <div className="w-full bg-[#F7F3E9] border border-[#EAE4D7] rounded-lg p-2.5 flex items-center gap-4 shadow-sm">
                    <button
                      type="button"
                      onClick={handleUploadClick}
                      className="bg-[#FFD600] hover:bg-[#e6c200] text-black border-none rounded-xl px-5 py-2 text-[10px] font-bold transition-all shadow-sm cursor-pointer"
                    >
                      Choose a file
                    </button>
                    ...
                    {articleImagePreview ? (
                      ...
                      <span className="text-[10px] text-[#777777]">
                        {articleInput.imageFile ? articleInput.imageFile.name : 'No file choosen'}
                      </span>
                    )}
                  </div>
                </div>
                ...
                <div className="flex justify-end mt-2">
                  <button
                    type="submit"
                    className="inline-flex items-center justify-center bg-[#7EC07E] hover:bg-[#6EB06E] text-[#0D2B14] font-bold text-xs px-6 py-2 rounded-lg shadow-sm transition-all cursor-pointer border-none"
                  >
