      ...
      <div className="w-full flex flex-col gap-6">
        ...
        {viewMode === "list" && (
          <>
            ...
            {/* CARD UTAMA */}
            <div className="bg-white rounded-xl shadow-xs text-left w-full overflow-hidden pb-6">
              {/* HEADER PESAN MASUK*/}
              ...
              <div className="p-6 flex flex-col gap-4 w-full">
                ...
                <div className="relative w-full max-w-[220px]">
                  <input
                    ...
                    className="w-full bg-white border border-[#D1D5DB] rounded-xl py-2 pl-3.5 pr-9 text-xs text-gray-700 outline-none focus:ring-1 focus:ring-[#4285F4]"
                  />
                  <Search
                    size={15}
                ...
                {/* TABEL PESAN MASUK */}
                <div className="border border-[#E5E7EB] rounded-xl overflow-hidden bg-white w-full mt-1">
        ...
        {viewMode === "detail" && selectedMessage && (
          <div className="w-full flex flex-col gap-6">
            ...
            <div className="bg-white rounded-xl shadow-xs text-left w-full overflow-hidden pb-12">
              ...
              <div className="p-6 md:p-8 flex flex-col gap-8 w-full max-w-[800px]">
